...
async function loadVerse() {
    ...
    try {
        ...
        //document.getElementById("verse-text").textContent = `"${verse.text.trim()}"`

        //document.getElementById('verse-ref').textContent = `— ${verse.book} ${verse.chapter}:${verse.verse}`;
    } catch (error) {
        //document.getElementById('verse-text').textContent = '"For God so loved the world that he gave his one and only Son."';
